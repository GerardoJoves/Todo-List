...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n    box-sizing: border-box;\n    font-size: 16px;\n    --main-color: rgb(250, 150, 50);\n    --text-color: rgb(32, 32, 32);\n}\n\n*, *:before, *:after {\n    box-sizing: inherit;\n}\n\nbody, h1, h2, h3, h4, h5, h6, p, ol, ul {\n    margin: 0;\n    padding: 0;\n    font-weight: normal;\n}\n\nbody {\n    font-family: sans-serif;\n    color: var(--text-color);\n    min-height: 100vh;\n    display: grid;\n    grid-template-rows: auto 1fr;\n}\n\nol, ul {\n    list-style: none;\n}\n\nimg {\n    max-width: 100%;\n    height: auto;\n}\n\nheader {\n    background-color: var(--main-color);\n    padding: 6px 40px;\n}\n\n.content {\n    display: flex;\n    position: relative;\n}\n\n#left-menu { \n    display: none;\n}\n\n#left-menu.active {\n    display: block;\n    display: flex;\n}\n\n@media only screen and (max-width: 800px) {\n    #left-menu.active {\n        position: absolute;\n        background-color: rgba(39, 39, 39, 0.363);\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n    }\n}\n\n#left-menu .project-input > div:nth-child(2) {\n    display: grid;\n    gap: 5px;\n    grid-auto-flow: column;\n    margin-top: 10px;\n}\n\n#left-menu .project-input > div:first-child {\n    display: flex;\n    gap: 10px;\n}\n\n#left-menu .project-input.hidden {\n    display: none;\n}\n\n#left-menu > div{\n    padding: 38px 12px 24px 24px;\n    background-color: rgb(245, 245, 245);\n    width: 300px;\n}\n\n#left-menu > div > div:nth-child(2) {\n    margin: 8px 0;\n    font-weight: bold;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\n#left-menu > div > div:not(.projects-container), \n#left-menu .projects-container > div{\n    padding: 10px;\n    border-radius: 5px;\n}\n\n#left-menu .projects-container > div:hover, \n#left-menu .projects-container > .on-display {\n    background-color: rgb(221, 221, 221);\n    cursor: pointer;\n}\n\n#left-menu .projects-container > div {\n    display: flex;\n    justify-content: space-between;\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,eAAe;IACf,+BAA+B;IAC/B,6BAA6B;AACjC;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,SAAS;IACT,UAAU;IACV,mBAAmB;AACvB;;AAEA;IACI,uBAAuB;IACvB,wBAAwB;IACxB,iBAAiB;IACjB,aAAa;IACb,4BAA4B;AAChC;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,eAAe;IACf,YAAY;AAChB;;AAEA;IACI,mCAAmC;IACnC,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,cAAc;IACd,aAAa;AACjB;;AAEA;IACI;QACI,kBAAkB;QAClB,yCAAyC;QACzC,MAAM;QACN,OAAO;QACP,WAAW;QACX,YAAY;IAChB;AACJ;;AAEA;IACI,aAAa;IACb,QAAQ;IACR,sBAAsB;IACtB,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,SAAS;AACb;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,4BAA4B;IAC5B,oCAAoC;IACpC,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,iBAAiB;IACjB,aAAa;IACb,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;;IAEI,aAAa;IACb,kBAAkB;AACtB;;AAEA;;IAEI,oCAAoC;IACpC,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC","sourcesContent":["html {\n    box-sizing: border-box;\n    font-size: 16px;\n    --main-color: rgb(250, 150, 50);\n    --text-color: rgb(32, 32, 32);\n}\n\n*, *:before, *:after {\n    box-sizing: inherit;\n}\n\nbody, h1, h2, h3, h4, h5, h6, p, ol, ul {\n    margin: 0;\n    padding: 0;\n    font-weight: normal;\n}\n\nbody {\n    font-family: sans-serif;\n    color: var(--text-color);\n    min-height: 100vh;\n    display: grid;\n    grid-template-rows: auto 1fr;\n}\n\nol, ul {\n    list-style: none;\n}\n\nimg {\n    max-width: 100%;\n    height: auto;\n}\n\nheader {\n    background-color: var(--main-color);\n    padding: 6px 40px;\n}\n\n.content {\n    display: flex;\n    position: relative;\n}\n\n#left-menu { \n    display: none;\n}\n\n#left-menu.active {\n    display: block;\n    display: flex;\n}\n\n@media only screen and (max-width: 800px) {\n    #left-menu.active {\n        position: absolute;\n        background-color: rgba(39, 39, 39, 0.363);\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n    }\n}\n\n#left-menu .project-input > div:nth-child(2) {\n    display: grid;\n    gap: 5px;\n    grid-auto-flow: column;\n    margin-top: 10px;\n}\n\n#left-menu .project-input > div:first-child {\n    display: flex;\n    gap: 10px;\n}\n\n#left-menu .project-input.hidden {\n    display: none;\n}\n\n#left-menu > div{\n    padding: 38px 12px 24px 24px;\n    background-color: rgb(245, 245, 245);\n    width: 300px;\n}\n\n#left-menu > div > div:nth-child(2) {\n    margin: 8px 0;\n    font-weight: bold;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n}\n\n#left-menu > div > div:not(.projects-container), \n#left-menu .projects-container > div{\n    padding: 10px;\n    border-radius: 5px;\n}\n\n#left-menu .projects-container > div:hover, \n#left-menu .projects-container > .on-display {\n    background-color: rgb(221, 221, 221);\n    cursor: pointer;\n}\n\n#left-menu .projects-container > div {\n    display: flex;\n    justify-content: space-between;\n}"],"sourceRoot":""}]);
// Exports
...
const projects = (function() {
    const index = new _project__WEBPACK_IMPORTED_MODULE_2__.Project({
        title: 'Index'
    });
...
_events__WEBPACK_IMPORTED_MODULE_4__.events.on('addTask', (taskInfo) => {
    projects.currentOnDisplay.addTask(new _task__WEBPACK_IMPORTED_MODULE_3__.Task(taskInfo))
    ;(0,lit_html__WEBPACK_IMPORTED_MODULE_1__.render)((0,_templates__WEBPACK_IMPORTED_MODULE_5__.projectTemplate)(projects.currentOnDisplay), projectDisplayContainer)
...
_events__WEBPACK_IMPORTED_MODULE_4__.events.on('renderProject', (project) => {
    ...
    (0,lit_html__WEBPACK_IMPORTED_MODULE_1__.render)((0,_templates__WEBPACK_IMPORTED_MODULE_5__.projectTemplate)(project), projectDisplayContainer)
    ;(0,lit_html__WEBPACK_IMPORTED_MODULE_1__.render)((0,_templates__WEBPACK_IMPORTED_MODULE_5__.leftMenuTemplate)(projects), leftMenu)
})

_events__WEBPACK_IMPORTED_MODULE_4__.events.on('createProject', (projectInfo) => {
    projects.addCustomProject(new _project__WEBPACK_IMPORTED_MODULE_2__.Project(projectInfo))
    ;(0,lit_html__WEBPACK_IMPORTED_MODULE_1__.render)((0,_templates__WEBPACK_IMPORTED_MODULE_5__.leftMenuTemplate)(projects), leftMenu)
})
...
function taskInputTemplate() {
    let titleRef = (0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__.createRef)()
    let descriptionRef = (0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__.createRef)();

    function addTaskHandler() {
        _events__WEBPACK_IMPORTED_MODULE_2__.events.emit('addTask', {
    ...
    return lit_html__WEBPACK_IMPORTED_MODULE_0__.html`
        <div>
            <div>
                <label>Title</label>
                <input ${(0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__.ref)(titleRef)} tyep="text" />
            </div>
            <div>
                <label>Description</div>
                <input ${(0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__.ref)(descriptionRef)} type="text" />
            </div>
            <div>
...
function leftMenuTemplate(projects) {
    ...
    function displayProject(project) {
        ...
        _events__WEBPACK_IMPORTED_MODULE_2__.events.emit('renderProject', project);
    }
    ...
    function addProjectInput() {
        ...
        return lit_html__WEBPACK_IMPORTED_MODULE_0__.html`
            <div class="project-input" ${(0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__.ref)(inputRef)}>
                <div>
                    <label>Title</label>
                    <input ${(0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_1__.ref)(titleRef)} type="text">
                </div>
                <div>
                    <button @click=${() => _events__WEBPACK_IMPORTED_MODULE_2__.events.emit('createProject', {
                        title: titleRef.value.value
                    })} type="button">
                        Create Project
                    </button>
