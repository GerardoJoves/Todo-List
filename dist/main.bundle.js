...
let currentProject = new _project__WEBPACK_IMPORTED_MODULE_3__.Project({
    title: 'Index'
});

const taskInput = {
    titleRef: (0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_2__.createRef)(),
    descriptionRef: (0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_2__.createRef)(),
}

function addTaskHandler(e) {
    currentProject.addTask(new _task__WEBPACK_IMPORTED_MODULE_4__.Task({
        title: taskInput.titleRef.value.value,
        description: taskInput.descriptionRef.value.value,
        dueDate: 'empty',
        priority: 'empty',
    }))
    _events__WEBPACK_IMPORTED_MODULE_5__.events.emit('newTaskAdded', {project: currentProject});
}
...
function taskInputTemplate(inputObj) {
    return lit_html__WEBPACK_IMPORTED_MODULE_1__.html`
        <div>
            <div>
                <label>Title</label>
                <input ${(0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_2__.ref)(inputObj.titleRef)} tyep="text" />
            </div>
            <div>
                <label>Description</div>
                <input ${(0,lit_html_directives_ref_js__WEBPACK_IMPORTED_MODULE_2__.ref)(inputObj.descriptionRef)} type="text" />
            </div>
            <div>
...
_events__WEBPACK_IMPORTED_MODULE_5__.events.on('newTaskAdded', () => {
    (0,lit_html__WEBPACK_IMPORTED_MODULE_1__.render)(projectTemplate(currentProject), projectDisplay);
})
